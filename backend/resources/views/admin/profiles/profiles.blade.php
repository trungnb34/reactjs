...
<div class="col-md-12">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#timeline" data-toggle="tab">Settings</a></li>
        <li><a href="#settings" data-toggle="tab">Security</a></li>
    </ul>
        ...
        <!-- Post -->
            <form class="form-horizontal">
                <div class="form-group">
                    <h3 for="inputName" class="col-sm-3 control-label">Public Profile</h3>
                </div>
                <hr />
                <div class="form-group">
